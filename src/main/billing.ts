...
export abstract class Billing {
    ...
    async CheckPerformTransaction(body: IRequestBodyRPC<ICheckPerformTransactionParams>) {
    ...
    async CreateTransaction(body: IRequestBodyRPC<ICreateTransactionParams>, transaction: ITransaction) {
    ...
    async PerformTransaction(body: IRequestBodyRPC<IPerformTransactionParams>, transaction: ITransaction) {
    ...
    async CancelTransaction(body: IRequestBodyRPC<ICancelTransaction>, transaction: ITransaction) {
    ...
    async CheckTransaction(body: IRequestBodyRPC<ICheckTransactionParams>, transaction: ITransaction) {
    ...
    async GetStatement(body: IRequestBodyRPC<IGetStatementParams>, transaction: ITransaction) {
        return {
